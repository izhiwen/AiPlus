...
This checklist tracks the Owner-approved v0.4.5 GitHub Release scope. It does
...
- [x] Owner approves git push for reviewed v0.4.5 source/docs changes.
- [x] Owner approves creating the `v0.4.5` git tag.
- [x] Owner approves the `v0.4.5` GitHub Release.
...
- [x] No publication actions outside the Owner-approved v0.4.5 GitHub Release
      scope executed.
...
- [x] Owner approved the v0.4.5 upload scope before release artifact creation.
