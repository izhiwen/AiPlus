...
- pushing commits outside the reviewed v0.2.0 release scope
- creating or pushing git tags beyond `v0.2.0`
- creating GitHub Releases beyond `v0.2.0`
- uploading binary artifacts beyond the verified v0.2.0 macOS Apple Silicon
...
Owner approved v0.2.0 GitHub Release creation, the verified macOS Apple Silicon
