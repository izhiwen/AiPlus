...
Environment:
  AIPLUS_VERSION      Release version to install, default v0.4.3
...
AiPlus v0.4.3 publishes a verified macOS Apple Silicon asset first. Other
...
detect_asset() {
  ...
  case "$os:$arch" in
    Darwin:arm64|Darwin:aarch64)
      ...
      ;;
    *)
      echo "ERROR no verified AiPlus v0.4.3 binary asset for: $os $arch" >&2
