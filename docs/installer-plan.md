...
This document describes the v0.1.3 installer for the `aiplus` command.
...
- install v0.1.3 only on platforms with a verified published asset
...
## v0.1.3 Release Artifact Requirements

The v0.1.3 installer is activated for macOS Apple Silicon after these checks:
...
Owner approved these v0.1.3 actions:

- creating the v0.1.3 tag and GitHub Release
