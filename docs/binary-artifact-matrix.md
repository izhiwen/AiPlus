...
v0.1.1 publishes the verified local macOS Apple Silicon asset first. Other
...
| --- | --- | --- | --- | --- | --- | --- |
| `aiplus-aarch64-apple-darwin.tar.gz` | `aarch64-apple-darwin` | `cargo build --release --target aarch64-apple-darwin` | included in `checksums.txt` | Not signed or notarized yet | Verified locally for v0.1.1 | Approved for v0.1.1 |
...
The v0.1.1 macOS Apple Silicon archive contains:
